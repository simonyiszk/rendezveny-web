...
export class InitialDatabase1606516794419 implements MigrationInterface {
    name = 'InitialDatabase1606516794419'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `event` (`id` varchar(36) NOT NULL, `name` varchar(255) NOT NULL, `uniqueName` varchar(255) NOT NULL, `description` varchar(255) NOT NULL, `place` varchar(255) NULL, `capacity` int NULL, `start` timestamp NULL, `end` timestamp NULL, `isDateOrTime` tinyint NOT NULL, `registrationStart` timestamp NULL, `registrationEnd` timestamp NULL, `registrationAllowed` tinyint NULL, `isClosedEvent` tinyint NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
